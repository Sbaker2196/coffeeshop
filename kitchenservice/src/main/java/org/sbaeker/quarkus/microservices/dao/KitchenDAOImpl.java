 ...
 * database. This DAO implementation is specifically designed for the kitchen service.
 *
 * <p>Usage example:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>The KitchenDAOImpl class is an application-scoped CDI bean and uses dependency injection to
